...
pub(crate) fn prompt(rcfg: &RenderConfig) -> anyhow::Result<PathBuf> {
...
pub(crate) fn check_loc(loc: &PathBuf) -> anyhow::Result<()> {
...
pub(crate) fn get_name(loc: &PathBuf, abs: &PathBuf) -> anyhow::Result<String> {
