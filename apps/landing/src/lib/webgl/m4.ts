...
export function rotateX(a: number[], angleInRadians: number) {
...
export function rotateY(a: number[], angleInRadians: number) {
	const c = Math.cos(angleInRadians)
	const s = Math.sin(angleInRadians)
...
export function rotateZ(a: number[], angleInRadians: number) {
	const c = Math.cos(angleInRadians)
	const s = Math.sin(angleInRadians)
